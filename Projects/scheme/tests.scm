...
(define (function param1 param2) (+ param1 param2))
; expect function

(1 2)
; expect Error: int is not callable: 1

(define function1 (mu (a b) (+ 10 a b)))
; expect function1

(define function2 (lambda (x y) (function1 (* x x) 3) (* y 3)))
; expect function2
...
(define function (begin (display 'this-first) (+ 2 3) (* 10 10)))
; expect this-firstfunction

(and True True 0 False (/ 100 0))
; expect False

(and (1/0) True True False)
; expect Error

(define a 1)
; expect a

(let ((x 100) (a 10) (y (* a 10))) (list x a y))
; expect (100 10 10)

(or False False False False 1 (1/0))
; expect 1

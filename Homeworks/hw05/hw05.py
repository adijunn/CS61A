...
def multiple_references_explanation():
    ...
    "An interval used twice in the same expression allows for multiple correct values which increases the uncertainty (larger interval)"
...
def quadratic(x, a, b, c):
    ...
    lower, upper, extreme = map(f, (lower_bound(x), upper_bound(x), extreme_point))
